...
void main() {
  ...
  testWithoutContext('getDartNameForDarwinArch returns name used in Dart SDK', () {
    ...
    expect(CpuArch.loong64.dartName, 'loong64');
  });
  ...
  testWithoutContext('CpuArch', () {
    ...
    expect(CpuArch.fromName('loong64'), CpuArch.loong64);
    expect(CpuArch.fromName('loongarch64'), CpuArch.loong64);
    ...
    expect(CpuArch.loong64.name, 'loong64');
